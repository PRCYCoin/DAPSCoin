...
// Copyright (c) <firstYear>-<lastYear> The PRivaCY Coin Developers

will be updated to:

// Copyright (c) <firstYear>-<lastModifiedYear> The PRivaCY Coin Developers

where <lastModifiedYear> is obtained from the 'git log' history.

This subcommand also handles copyright headers that have only a single year. In those cases:

// Copyright (c) <year> The PRivaCY Coin Developers

will be updated to:

// Copyright (c) <year>-<lastModifiedYear> The PRivaCY Coin Developers
